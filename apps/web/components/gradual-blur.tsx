...
function mergeConfigs(...configs: Partial<GradualBlurProps>[]): Partial<GradualBlurProps> {
...
function useResponsiveDimension(responsive: boolean | undefined, config: Partial<GradualBlurProps>, key: keyof GradualBlurProps) {
...
function useIntersectionObserver(ref: React.RefObject<HTMLDivElement>, shouldObserve: boolean = false) {
