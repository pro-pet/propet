...
import { AiMagicIcon, Bone01Icon, Home11Icon, Mail01Icon, Notification01Icon, SentIcon, ShoppingBag01Icon, UserIcon } from '@hugeicons/core-free-icons'
...
const mainItems: DockItem[] = [
  ...
  { href: '/pets', label: '宠物', icon: Bone01Icon },
